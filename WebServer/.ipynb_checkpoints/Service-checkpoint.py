...
if bg_image:
    ...
    if canvas_result.json_data is not None:
        ...
        # 이미지 DB로 전송. 
        # TODO : inference 결과 나온 뒤 insert하는 것으로 수정
        INFERENCE_TYPE = 'temp_inpainting' # TODO 모듈 통합 후 수정
        image_name = uuid.uuid4().hex
        input_url = send_to_bucket(image_name+'input.jpg', image_bytes)
        inference_url = send_to_bucket(image_name+'inference.jpg', response.content)
        insert_data(INFERENCE_TYPE, input_url, inference_url)